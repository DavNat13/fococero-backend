...
export class ReporteRepository {
     ...
     * PostgreSQL guardará el plan de ejecución en caché. Las próximas inserciones serán muchísimo más rápidas.
     */
    static async crear(data: ICreateReporteDTO): Promise<IReporte> {
        const query: QueryConfig = {
            ...
            `,
            // pg convierte el objeto literal a JSONB automáticamente de forma nativa
            values: [data.categoria_id, data.titulo, data.descripcion, data.latitud, data.longitud, data.id_ciudadano, data.metadata || {}]
        };
     ...
     * Separamos el COUNT y el SELECT y los ejecutamos AL MISMO TIEMPO con Promise.all.
     * Esto reduce el tiempo de respuesta a la mitad en tablas masivas.
     */
    static async obtenerTodos(limit: number, offset: number): Promise<{ total: number, data: IReporte[] }> {
    ...
    /**
     * 🚀 OPTIMIZACIÓN 3: Búsqueda por índice primario con caché.
     */
    ...
    /**
     * 🚀 OPTIMIZACIÓN 4: Transacción limpia con Prepared Statements.
     */
        ...
        try {
            ...
            const historyQuery: QueryConfig = {
                ...
                text: `
                    ...
                    VALUES ($1, $2, $3, $4, $5);
                `,
                values: [reporteId, estadoAnterior, estadoNuevo, idUsuarioModificador, comentarios || null]
            };
